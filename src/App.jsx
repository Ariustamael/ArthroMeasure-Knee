...
export default function ArthroAlignKnee() {
  ...
  const handleCopy = () => {
    if (!results) return;
    const data = `ArthroAlign - Knee Result (${side} Side)\n---\n` + 
    ...
    <div className="flex h-screen w-full bg-[#F5F2ED] font-sans text-[#4A4A4A] overflow-hidden select-none" 
      ...
      <aside className="w-80 bg-white border-r border-[#E5DED1] flex flex-col shadow-sm z-30">
        <div className="p-8 pb-4">
          <h1 className="text-2xl font-light tracking-tighter text-[#2D2D2D] mb-6">ArthroAlign - Knee</h1>
